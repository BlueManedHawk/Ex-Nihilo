...
COMPILE_COMMAND = clang-11 $(FORMATTING_OPTIONS) $(DIAGNOSTIC_OPTIONS) $(OTHER_OPTIONS)
...
debug:
	$(COMPILE_COMMAND) $(DEBUGGING_OPTIONS) -DEX_NIHILO_DEBUG_MODE Ex\ Nihilo\ DEBUG.elf -o $(COMMON_BINARY_OUTPUT)
